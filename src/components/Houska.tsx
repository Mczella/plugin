...
const items = [
    {
        imageUrl: "https://static.vecteezy.com/system/resources/previews/009/262/531/original/cute-panda-welcomes-with-a-paw-the-panda-is-waving-its-paw-illustration-isolated-on-white-background-vector.jpg",
        text: "Smažený sýr"
    },
    {
        imageUrl: "https://static.vecteezy.com/system/resources/previews/009/262/531/original/cute-panda-welcomes-with-a-paw-the-panda-is-waving-its-paw-illustration-isolated-on-white-background-vector.jpg",
...
export function Houska(): React.ReactElement | null {
    ...
    const bannerSpace = document.querySelector('[data-gtm-section="hp-topBanner"]')
