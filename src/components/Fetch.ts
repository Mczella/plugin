...
export const fetchProducts = async (productIds: string[]) => {
    const url = `https://www.rohlik.cz/api/v1/products?products=${productIds.join('&products=')}`
...
export const fetchStock = async (productIds: string[]) => {
    const url = `https://www.rohlik.cz/api/v1/products/stock?products=${productIds.join('&products=')}`
...
export const fetchPrices = async (productIds: string[]) => {
    const url = `https://www.rohlik.cz/api/v1/products/prices?products=${productIds.join('&products=')}`
